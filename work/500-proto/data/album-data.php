...
$album_data = [
    ...
    [
       ...
       'artist' => 'Magnetic Fields',
        'title' => '69 Love Songs',
        'description' => '“It started with the title,” Stephin Merritt said of 69 Love Songs, which he imagined in the Sinatra-era tradition of “theme” albums. A tour de force of pop mastery, his three-disc splurge had everything from lounge jazz to Podunk country to punk parody, peaking with sidelong standards like “Papa Was a Rodeo” and “The Luckiest Guy on the Lower East Side.” God-level moment: “The Death of FerdiTBAd de Saussure,” which is titled after a French linguist and rhymes his name with closure, bulldozer, and classic Motown songwriting team Holland-Dozier-Holland, hooking it all to an unforgettable tune.',
    ...
    [
       ...
       'artist' => 'Lana Del Rey',
        ...
        'description' => 'Lana Del Rey became a music-blog sensation playing the poker-faced millennial TBAcy Sinatra on her debut single, “Video Games.” She kept growing as an artist, and on her wonderfully titled sixth album perfected her epic vision of doomed, decadent, Seventies-steeped California romance on songs like “Mariner’s Apartment Complex” and the nine-minute crusher “Venice Bitch.” Del Rey dropped references to the Eagles and Graham Nash, merging her own music into the Laurel Canyon canon. No less an authority on Seventies greatness than Elton John called the album&#8217;s songs “timeless.”',
    ...
    [
       ...
       'artist' => 'Björk',
        'title' => 'Post',
        'description' => '“I have to re-create the universe every morning when I wake up,” Björk said, explaining her second solo album’s utter lack of musical inhibition. Post bounces from big-band jazz (“It’s Oh So Quiet”) to trip-hop (“These Modern Things” seems to be both of those things at once). Lush and disorienting, dissoTBAt yet ensnaringly lovely, it proved the “Icelandic pixie” who’d dazzled MTV viewers fronting the Sugarcubes, was, in fact, one of the Nineties’ truly boundless musical thinkers. Fun fact: For her vocals, Björk extended her mic cord to a beach so she could sing to the sea.',
    ...
    [
       ...
       'artist' => 'Tori Amos',
        ...
        'description' => 'Here Tori Amos established herself as the poet laureate for a generation of battle-worn young women no longer satisfied with silence. From behind a piano that she wields like a machete aside her sharp, poigTBAt reflections, Little Earthquakes is an incisive reflection on sexual assault, abuse, PTSD, and coming of age under the heavy veil of it all. At times thorny and confrontational, Amos’ voice still remains a warm invitation to people, like her, learning how to diffuse their trauma and move forward as best they can.',
    ...
    [
       ...
       'artist' => 'Pearl Jam',
        'title' => 'Ten',
        'description' => 'More than any of the Northwest bands that preceded them, Pearl Jam turned grunge into rock’s domiTBAt new sound. Their first album includes stories about homelessness (“Even Flow”), murder (“Once”), execution (“Footsteps”), incest (“Alive”), psychiatric hospitals (“Why Go”), and romantic disappointment (“Black”). Most notoriously, “Jeremy” told the story of a high school kid who takes revenge on his bullies by killing himself in class — though the lyrics don’t make that clear, the accompanying video did. Pearl Jam committed themselves to songs of darkness and trouble, especially in adolescent life, and Eddie Vedder delivers them with conviction, in a voice that makes you feel like the events are happening right now, in front of you.',
