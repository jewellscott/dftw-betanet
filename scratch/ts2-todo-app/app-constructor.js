const todoApp = {
	...
	Household: function(name, subhood, notes = "", ...members) {
		this.id = ++todoApp.idCount,
		this.round = todoApp.currentRound,
		this.name = name,
	...
	createHousehold(name, subhood, notes = "", ...members) {
		...
		// 		notes: notes,
		// 	}
		let household = new this.Household(name, subhood, notes, members);
